////
//// Created by z645880 on 18.10.18.
////
//
//#ifndef DIL_NODE_IMPLEMENTATION_ROS_CPP_JOY_EVENT_H
//#define DIL_NODE_IMPLEMENTATION_ROS_CPP_JOY_EVENT_H
//
//#include <string>
//#include <iostream>
//#include <sys/types.h>
...
//     */
//    friend std::ostream& operator<<(std::ostream& os, const joy_event& e);
//};
//
///**
...
// *    cout << event << endl;
// */
//std::ostream& operator<<(std::ostream& os, const joy_event& e);
//
///**
...
//     */
//    bool sample(joy_event* event);
//};
//#endif //DIL_NODE_IMPLEMENTATION_ROS_CPP_JOY_EVENT_H
